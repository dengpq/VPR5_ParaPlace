...
void print_relative_pos_distr(void)
{
    ...
    total_conn = (int*)my_malloc((num_grid_columns + num_grid_rows + 1) * sizeof(int));
    relapos = (int**)my_malloc((num_grid_columns + num_grid_rows + 1) * sizeof(int*));
    relapos_distr = (double**)my_malloc((num_grid_columns + num_grid_rows + 1) * sizeof(double*));
    ...
    for (len = 1; len <= num_grid_columns + num_grid_rows; len++) {
        if (total_conn[len] != 0) {
