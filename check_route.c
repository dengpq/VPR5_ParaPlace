...
static void check_sink(int inode,
                       int inet,
                       boolean* pin_done);
static void check_switch(trace_t* tptr,
                         int num_switch);
...
static void recompute_occupancy_from_scratch(vector_t** fb_opins_used_locally);
static void check_locally_used_fb_opins(vector_t** fb_opins_used_locally,
                                        router_types_t route_type);
...
void
check_route(router_types_t route_type,
            int num_switch,
               ...
               int to_node)
{
    ...
    block_type_ptr from_grid_type, to_grid_type;
    reached = FALSE;
...
static void
recompute_occupancy_from_scratch(vector_t** fb_opins_used_locally)
{
...
static void
check_locally_used_fb_opins(vector_t** fb_opins_used_locally,
                            router_types_t route_type)
{
