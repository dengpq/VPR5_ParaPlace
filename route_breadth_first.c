...
static void breadth_first_expand_trace_segment(trace_t* start_ptr,
                                               int
...
boolean
try_breadth_first_route(router_opts_t router_opts,
...
static void
breadth_first_expand_trace_segment(trace_t* start_ptr,
