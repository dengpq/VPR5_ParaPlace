 ...
 * [from_side][to_side][from_track].  That yields an integer vector_t (ivec)  *
...
int get_simple_switch_block_track(IN side_types_t from_side,
...
static side_types_t get_sbox_side(IN int get_i,
                                 IN int get_j,
                                 IN rr_type_t get_type,
                                 IN int comp_i,
                                 IN int comp_j);
...
void
free_switch_block_conn(vector_t** *switch_block_conn,
                       int nodes_per_chan)
{
...
int
get_simple_switch_block_track(IN side_types_t from_side,
                              IN side_types_t to_side,
                              IN int from_track,
