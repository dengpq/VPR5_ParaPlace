                          ...
                          type_descriptor_t* Type)
{
    ...
    Type->class_inf = (pin_class_t*)my_malloc(Type->num_class * sizeof(pin_class_t));
                               ...
                               type_descriptor_t* Type)
{
    ...
    Type->grid_loc_def = (grid_loc_def_t*)my_calloc(Type->num_grid_loc_def,
                                  sizeof(grid_loc_def_t));
    /* Load the pin locations */
    int i = 0;
    ezxml_t Cur = Locations->child;
    while (Cur) {
...
static void SetupSubblocksTcomb(ezxml_t timing,
                                type_descriptor_t* Type)
{
    T_subblock_t** T_subblock_ptr = &Type->type_timing_inf.T_subblock;
                             ...
                             boolean timing_enabled)
{
    ...
    if (CurType != NULL) {
        Type->type_timing_inf.T_subblock = (T_subblock_t*)my_malloc(Type->max_subblocks *
                                                                    sizeof(T_subblock_t));
                      ...
                      IN boolean timing_enabled)
{
    ...
    type_descriptor_t* type = &type_descriptors[IO_TYPE->index];
    type->name = ".io";
    type->height = 1;
    /* Load capacity */
    ...
    type->class_inf = (pin_class_t*)my_malloc(sizeof(pin_class_t) *
                                                   3 * capacity);
    ...
    type->grid_loc_def = (grid_loc_def_t*)my_calloc(1, sizeof(grid_loc_def_t));
    ...
    if (timing_enabled) {
        ...
        type->type_timing_inf.T_sblk_opin_to_fb_opin  =  0;
        type->type_timing_inf.T_sblk_opin_to_sblk_ipin  = 0;
        type->type_timing_inf.T_subblock  =  (T_subblock_t*)my_malloc(sizeof(T_subblock_t));
                         ...
                         boolean timing_enabled)
{
    ...
    *Types = (type_descriptor_t*)my_malloc(sizeof(type_descriptor_t) * (*NumTypes));
    ...
    while (CurType != NULL) {
        ...
        type_descriptor_t* Type = &(*Types)[i];
                            ...
                            IN boolean timing_enabled)
{
    ...
    *Switches = NULL;
    ...
    if (*NumSwitches > 0) {
        *Switches = (switch_info_t*)my_malloc(*NumSwitches * sizeof(switch_info_t));
        memset(*Switches, 0, (*NumSwitches * sizeof(switch_info_t)));
    }
