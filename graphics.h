...
enum color_types {
    WHITE = 0,
    BLACK, DARKGREY, LIGHTGREY, BLUE, GREEN, YELLOW,
...
void event_loop(void (*act_on_button)(double x,
                                      double y),
...
void drawarc(double xcen,
             double ycen,
             double rad,
             double startang,
             double angextent);
void fillarc(double xcen,
             double ycen,
             double rad,
             double startang,
             double angextent);
