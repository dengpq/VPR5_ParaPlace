...
double**
alloc_net_delay(linked_vptr_t** chunk_list_head_ptr)
{
...
void
free_net_delay(double** net_delay,
...
void
load_net_delay_from_routing(double** net_delay)
{
                        ...
                        double delay_value)
{
     ...
     * analysis before routing is done with a constant net Tdel model).         */
    int inet;
...
static void
load_one_net_delay(double** net_delay,
                   int inet,
                   t_linked_rc_ptr* rr_node_to_rc_node)
{
...
static void
load_one_constant_net_delay(double** net_delay,
                            int inet,
                            double delay_value)
{
...
void
print_net_delay(double** net_delay,
                char* fname)
{
